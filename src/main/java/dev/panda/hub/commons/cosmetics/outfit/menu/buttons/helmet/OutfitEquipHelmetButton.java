package dev.panda.hub.commons.cosmetics.outfit.menu.buttons.helmet;
...
@AllArgsConstructor
public class OutfitEquipHelmetButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        if (player.getInventory().getHelmet() == null) {
            ...
            ItemStack outfit = player.getInventory().getHelmet();
    ...
    public void clicked(Player player, int slot, ClickType clickType, int hotbarButton) {
        if (clickType.isLeftClick()) {
            OutfitHelmetMenu outfitHelmetMenu = new OutfitHelmetMenu();
            outfitHelmetMenu.openMenu(player);
        }
