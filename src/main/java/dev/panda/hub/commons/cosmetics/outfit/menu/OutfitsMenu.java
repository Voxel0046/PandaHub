...
import dev.panda.hub.commons.cosmetics.outfit.menu.buttons.OutfitButton;
import dev.panda.hub.commons.cosmetics.outfit.menu.buttons.leggings.OutfitLeggingsButton;
...
import dev.panda.hub.utilities.menu.pagination.PageButton;
...
public class OutfitsMenu extends PaginatedMenu {
    ...
    public String getPrePaginatedTitle(Player player) {
        return ChatUtil.translate(CosmeticService.OUTFITS_TITLE);
    }
    ...
    public Map<Integer, Button> getAllPagesButtons(Player player) {
        ...
        for (Outfit outfit : outfitManager.getOutfits().values()) {
            ...
            buttons.put(validSlots.get(index), new OutfitButton(outfit));
            index++;
        }
