...
@AllArgsConstructor
public class OutfitEquipLeggingsButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        if (player.getInventory().getLeggings() == null) {
            ...
            ItemStack outfit = player.getInventory().getLeggings();
    ...
    public void clicked(Player player, int slot, ClickType clickType, int hotbarButton) {
        if (clickType.isLeftClick()) {
            OutfitLeggingsMenu outfitLeggingsMenu = new OutfitLeggingsMenu();
            outfitLeggingsMenu.openMenu(player);
        }
